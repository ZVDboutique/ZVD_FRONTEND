    ...
    <Container maxWidth='xl' sx={{ py: 4, px: { xs: 2, sm: 3, md: 4, lg: 5 } }}>
      ...
      >
        ...
        >
          ...
          >
            Our dedicated team of experienced professionals works tirelessly to
            deliver top-tier services to our clients. With years of industry
            expertise, they provide trustworthy guidance and support to buyers,
            suppliers, and more. The Diamond Port oversees every aspect, from
            purchasing to shipping, including comprehensive door-to-door
            insurance for a seamless experience.
          </Typography>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            ...
            Whether you're a buyer or a supplier, our expert team ensures smooth
            transactions, secure shipping, and comprehensive insurance. Join our
            global network and experience a hassle-free way to trade diamonds!
          </Typography>
        </Box>
      ...
      <Box sx={{ mb: 8, position: 'relative' }}>
        ...
        >
          ...
          >
            ...
            >
              <LocalShippingIcon sx={{ color: '#1a3a5f', fontSize: '28px' }} />
            </Box>
          ...
          >
            ...
            >
              Our intuitive platform guarantees safe and seamless transactions.
              Choose from multiple suppliers and make worry-free payments with
